...
func (m *QueryPeriodDelegationsRequest) Reset()         { *m = QueryPeriodDelegationsRequest{} }
func (m *QueryPeriodDelegationsRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryPeriodDelegationsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPeriodDelegationsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPeriodDelegationsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPeriodDelegationsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPeriodDelegationsRequest.Merge(m, src)
}
func (m *QueryPeriodDelegationsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryPeriodDelegationsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPeriodDelegationsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPeriodDelegationsRequest proto.InternalMessageInfo
...
type QueryPeriodDelegationsResponse struct {
	...
	PeriodDelegationResponses []PeriodDelegationResponse `protobuf:"bytes,1,rep,name=period_delegation_responses,json=periodDelegationResponses,proto3" json:"period_delegation_responses"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryPeriodDelegationsResponse) Reset()         { *m = QueryPeriodDelegationsResponse{} }
func (m *QueryPeriodDelegationsResponse) String() string { return proto.CompactTextString(m) }
...
func (m *QueryPeriodDelegationsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPeriodDelegationsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPeriodDelegationsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPeriodDelegationsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPeriodDelegationsResponse.Merge(m, src)
}
func (m *QueryPeriodDelegationsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryPeriodDelegationsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPeriodDelegationsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPeriodDelegationsResponse proto.InternalMessageInfo

func (m *QueryPeriodDelegationsResponse) GetPeriodDelegationResponses() []PeriodDelegationResponse {
	if m != nil {
		return m.PeriodDelegationResponses
	}
	return nil
}

func (m *QueryPeriodDelegationsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryPeriodDelegationRequest) Reset()         { *m = QueryPeriodDelegationRequest{} }
func (m *QueryPeriodDelegationRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryPeriodDelegationRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPeriodDelegationRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPeriodDelegationRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPeriodDelegationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPeriodDelegationRequest.Merge(m, src)
}
func (m *QueryPeriodDelegationRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryPeriodDelegationRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPeriodDelegationRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPeriodDelegationRequest proto.InternalMessageInfo
...
type QueryPeriodDelegationResponse struct {
	...
	PeriodDelegationResponse PeriodDelegationResponse `protobuf:"bytes,1,opt,name=period_delegation_response,json=periodDelegationResponse,proto3" json:"period_delegation_response"`
}

func (m *QueryPeriodDelegationResponse) Reset()         { *m = QueryPeriodDelegationResponse{} }
func (m *QueryPeriodDelegationResponse) String() string { return proto.CompactTextString(m) }
...
func (m *QueryPeriodDelegationResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryPeriodDelegationResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryPeriodDelegationResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryPeriodDelegationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryPeriodDelegationResponse.Merge(m, src)
}
func (m *QueryPeriodDelegationResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryPeriodDelegationResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryPeriodDelegationResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryPeriodDelegationResponse proto.InternalMessageInfo

func (m *QueryPeriodDelegationResponse) GetPeriodDelegationResponse() PeriodDelegationResponse {
	if m != nil {
		return m.PeriodDelegationResponse
	}
...
func init() {
	...
	proto.RegisterType((*QueryDelegationsRequest)(nil), "cosmos.staking.v1beta1.QueryDelegationsRequest")
	proto.RegisterType((*QueryDelegationsResponse)(nil), "cosmos.staking.v1beta1.QueryDelegationsResponse")
	...
	proto.RegisterType((*QueryPeriodDelegationsRequest)(nil), "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest")
	proto.RegisterType((*QueryPeriodDelegationsResponse)(nil), "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse")
	proto.RegisterType((*QueryPeriodDelegationRequest)(nil), "cosmos.staking.v1beta1.QueryPeriodDelegationRequest")
	proto.RegisterType((*QueryPeriodDelegationResponse)(nil), "cosmos.staking.v1beta1.QueryPeriodDelegationResponse")
...
var fileDescriptor_f270127f442bbcd8 = []byte{
	...
	,
}
...
func (c *queryClient) Delegations(ctx context.Context, in *QueryDelegationsRequest, opts ...grpc.CallOption) (*QueryDelegationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v1beta1.Query/Delegations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PeriodDelegations(ctx context.Context, in *QueryPeriodDelegationsRequest, opts ...grpc.CallOption) (*QueryPeriodDelegationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v1beta1.Query/PeriodDelegations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PeriodDelegation(ctx context.Context, in *QueryPeriodDelegationRequest, opts ...grpc.CallOption) (*QueryPeriodDelegationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.staking.v1beta1.Query/PeriodDelegation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) PeriodDelegations(ctx context.Context, req *QueryPeriodDelegationsRequest) (*QueryPeriodDelegationsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PeriodDelegations not implemented")
}
func (*UnimplementedQueryServer) PeriodDelegation(ctx context.Context, req *QueryPeriodDelegationRequest) (*QueryPeriodDelegationResponse, error) {
...
func _Query_Delegations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v1beta1.Query/Delegations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PeriodDelegations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v1beta1.Query/PeriodDelegations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_PeriodDelegation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.staking.v1beta1.Query/PeriodDelegation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryPeriodDelegationsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPeriodDelegationsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPeriodDelegationsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPeriodDelegationsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPeriodDelegationsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPeriodDelegationsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.PeriodDelegationResponses) > 0 {
		for iNdEx := len(m.PeriodDelegationResponses) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PeriodDelegationResponses[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryPeriodDelegationRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPeriodDelegationRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPeriodDelegationRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.PeriodDelegationId) > 0 {
		...
		i = encodeVarintQuery(dAtA, i, uint64(len(m.PeriodDelegationId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ValidatorAddr) > 0 {
...
func (m *QueryPeriodDelegationResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryPeriodDelegationResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryPeriodDelegationResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.PeriodDelegationResponse.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryPeriodDelegationsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPeriodDelegationsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.PeriodDelegationResponses) > 0 {
		for _, e := range m.PeriodDelegationResponses {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryPeriodDelegationRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryPeriodDelegationResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.PeriodDelegationResponse.Size()
	n += 1 + l + sovQuery(uint64(l))
	return n
}
...
func (m *QueryPeriodDelegationsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPeriodDelegationsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPeriodDelegationsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryPeriodDelegationsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPeriodDelegationsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPeriodDelegationsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PeriodDelegationResponses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PeriodDelegationResponses = append(m.PeriodDelegationResponses, PeriodDelegationResponse{})
			if err := m.PeriodDelegationResponses[len(m.PeriodDelegationResponses)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *QueryPeriodDelegationRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPeriodDelegationRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPeriodDelegationRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryPeriodDelegationResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryPeriodDelegationResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryPeriodDelegationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PeriodDelegationResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PeriodDelegationResponse.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
