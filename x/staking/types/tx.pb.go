...
type MsgCreateValidator struct {
	...
	SupportTokenType int32       `protobuf:"varint,8,opt,name=support_token_type,json=supportTokenType,proto3" json:"support_token_type,omitempty"`
}
...
type MsgBeginRedelegate struct {
	...
	ApplyRewardsSharesFix bool        `protobuf:"varint,6,opt,name=apply_rewards_shares_fix,json=applyRewardsSharesFix,proto3" json:"apply_rewards_shares_fix,omitempty"`
}
...
type MsgBeginRedelegateResponse struct {
	...
	// amount returns the amount of redelegated coins
...
func (m *MsgBeginRedelegateResponse) GetAmount() types1.Coin {
	if m != nil {
		return m.Amount
	}
	return types1.Coin{}
...
type MsgUndelegate struct {
	...
	Amount                types1.Coin `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount"`
	PeriodDelegationId    string      `protobuf:"bytes,4,opt,name=period_delegation_id,json=periodDelegationId,proto3" json:"period_delegation_id,omitempty"`
	ApplyRewardsSharesFix bool        `protobuf:"varint,5,opt,name=apply_rewards_shares_fix,json=applyRewardsSharesFix,proto3" json:"apply_rewards_shares_fix,omitempty"`
}
...
var fileDescriptor_0926ef28816b35ab = []byte{
	...
	,
}
...
func (m *MsgBeginRedelegate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApplyRewardsSharesFix", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ApplyRewardsSharesFix = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
			if err != nil {
