...
var (
	md_QueryUbiRequest protoreflect.MessageDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_query_proto_init()
	md_QueryUbiRequest = File_cosmos_distribution_v1beta1_query_proto.Messages().ByName("QueryUbiRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryUbiRequest)(nil)

type fastReflection_QueryUbiRequest QueryUbiRequest

func (x *QueryUbiRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryUbiRequest)(x)
}

func (x *QueryUbiRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryUbiRequest_messageType fastReflection_QueryUbiRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryUbiRequest_messageType{}

type fastReflection_QueryUbiRequest_messageType struct{}

func (x fastReflection_QueryUbiRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryUbiRequest)(nil)
}
func (x fastReflection_QueryUbiRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryUbiRequest)
}
func (x fastReflection_QueryUbiRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryUbiRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryUbiRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryUbiRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryUbiRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryUbiRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryUbiRequest) New() protoreflect.Message {
	return new(fastReflection_QueryUbiRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryUbiRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryUbiRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryUbiRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryUbiRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryUbiRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryUbiRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryUbiRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryUbiRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryUbiRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.QueryUbiRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryUbiRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryUbiRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryUbiRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryUbiRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryUbiRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryUbiRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_QueryUbiResponse_1_list)(nil)

type _QueryUbiResponse_1_list struct {
	list *[]*v1beta1.DecCoin
}

func (x *_QueryUbiResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryUbiResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryUbiResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.DecCoin)
	(*x.list)[i] = concreteValue
}

func (x *_QueryUbiResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.DecCoin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryUbiResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.DecCoin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryUbiResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryUbiResponse_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.DecCoin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryUbiResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryUbiResponse      protoreflect.MessageDescriptor
	fd_QueryUbiResponse_pool protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_distribution_v1beta1_query_proto_init()
	md_QueryUbiResponse = File_cosmos_distribution_v1beta1_query_proto.Messages().ByName("QueryUbiResponse")
	fd_QueryUbiResponse_pool = md_QueryUbiResponse.Fields().ByName("pool")
}

var _ protoreflect.Message = (*fastReflection_QueryUbiResponse)(nil)

type fastReflection_QueryUbiResponse QueryUbiResponse

func (x *QueryUbiResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryUbiResponse)(x)
}

func (x *QueryUbiResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryUbiResponse_messageType fastReflection_QueryUbiResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryUbiResponse_messageType{}

type fastReflection_QueryUbiResponse_messageType struct{}

func (x fastReflection_QueryUbiResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryUbiResponse)(nil)
}
func (x fastReflection_QueryUbiResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryUbiResponse)
}
func (x fastReflection_QueryUbiResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryUbiResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryUbiResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryUbiResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryUbiResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryUbiResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryUbiResponse) New() protoreflect.Message {
	return new(fastReflection_QueryUbiResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryUbiResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryUbiResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryUbiResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Pool) != 0 {
		value := protoreflect.ValueOfList(&_QueryUbiResponse_1_list{list: &x.Pool})
		if !f(fd_QueryUbiResponse_pool, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryUbiResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		return len(x.Pool) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiResponse"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryUbiResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		x.Pool = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryUbiResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		if len(x.Pool) == 0 {
			return protoreflect.ValueOfList(&_QueryUbiResponse_1_list{})
		}
		listValue := &_QueryUbiResponse_1_list{list: &x.Pool}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiResponse"))
		}
		panic(fmt.Errorf("message cosmos.distribution.v1beta1.QueryUbiResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		lv := value.List()
		clv := lv.(*_QueryUbiResponse_1_list)
		x.Pool = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		if x.Pool == nil {
			x.Pool = []*v1beta1.DecCoin{}
		}
		value := &_QueryUbiResponse_1_list{list: &x.Pool}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryUbiResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.distribution.v1beta1.QueryUbiResponse.pool":
		list := []*v1beta1.DecCoin{}
		return protoreflect.ValueOfList(&_QueryUbiResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.distribution.v1beta1.QueryUbiResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryUbiResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.distribution.v1beta1.QueryUbiResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryUbiResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryUbiResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryUbiResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryUbiResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryUbiResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryUbiResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryUbiResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// QueryUbiRequest is the request type for the Query/Ubi RPC
// method.
type QueryUbiRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *QueryUbiRequest) Reset() {
	*x = QueryUbiRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_distribution_v1beta1_query_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
func (x *QueryUbiRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryUbiRequest) ProtoMessage() {}

// Deprecated: Use QueryUbiRequest.ProtoReflect.Descriptor instead.
func (*QueryUbiRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_distribution_v1beta1_query_proto_rawDescGZIP(), []int{18}
}

// QueryUbiResponse is the response type for the Query/Ubi
// RPC method.
type QueryUbiResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryUbiResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryUbiResponse) ProtoMessage() {}

// Deprecated: Use QueryUbiResponse.ProtoReflect.Descriptor instead.
func (*QueryUbiResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_distribution_v1beta1_query_proto_rawDescGZIP(), []int{19}
}

func (x *QueryUbiResponse) GetPool() []*v1beta1.DecCoin {
	if x != nil {
		return x.Pool
	}
	return nil
...
var file_cosmos_distribution_v1beta1_query_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x73, 0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x11,
	0x0a, 0x0f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x62, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x22, 0x7e, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x62, 0x69, 0x52, 0x65, 0x73,
	...
	0x6c, 0x32, 0x9b, 0x11, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x98, 0x01, 0x0a, 0x06,
	...
	,
...
var file_cosmos_distribution_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*QueryUbiRequest)(nil),                          // 18: cosmos.distribution.v1beta1.QueryUbiRequest
	(*QueryUbiResponse)(nil),                         // 19: cosmos.distribution.v1beta1.QueryUbiResponse
...
var file_cosmos_distribution_v1beta1_query_proto_depIdxs = []int32{
	...
	21, // 11: cosmos.distribution.v1beta1.QueryUbiResponse.pool:type_name -> cosmos.base.v1beta1.DecCoin
	...
	18, // 21: cosmos.distribution.v1beta1.Query.Ubi:input_type -> cosmos.distribution.v1beta1.QueryUbiRequest
	...
	19, // 31: cosmos.distribution.v1beta1.Query.Ubi:output_type -> cosmos.distribution.v1beta1.QueryUbiResponse
