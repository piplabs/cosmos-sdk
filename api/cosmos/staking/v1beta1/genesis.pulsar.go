...
var (
	...
	fd_GenesisState_period_delegations    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_period_delegations = md_GenesisState.Fields().ByName("period_delegations")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.PeriodDelegations) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_9_list{list: &x.PeriodDelegations})
		if !f(fd_GenesisState_period_delegations, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.GenesisState.period_delegations":
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.GenesisState.period_delegations":
		...
		listValue := &_GenesisState_9_list{list: &x.PeriodDelegations}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.GenesisState.period_delegations":
		if x.PeriodDelegations == nil {
			x.PeriodDelegations = []*PeriodDelegation{}
		}
		value := &_GenesisState_9_list{list: &x.PeriodDelegations}
		return protoreflect.ValueOfList(value)
	case "cosmos.staking.v1beta1.GenesisState.last_total_power":
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.PeriodDelegations) > 0 {
			for _, e := range x.PeriodDelegations {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PeriodDelegations) > 0 {
			for iNdEx := len(x.PeriodDelegations) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PeriodDelegations[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				...
				x.PeriodDelegations = append(x.PeriodDelegations, &PeriodDelegation{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PeriodDelegations[len(x.PeriodDelegations)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type GenesisState struct {
	...
	PeriodDelegations []*PeriodDelegation `protobuf:"bytes,9,rep,name=period_delegations,json=periodDelegations,proto3" json:"period_delegations,omitempty"`
}
...
func (x *GenesisState) GetPeriodDelegations() []*PeriodDelegation {
	if x != nil {
...
var file_cosmos_staking_v1beta1_genesis_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfb, 0x05, 0x0a, 0x0c, 0x47, 0x65, 0x6e,
	...
	0x65, 0x64, 0x12, 0x62, 0x0a, 0x12, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x64, 0x65, 0x6c,
	0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x11, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x68, 0x0a, 0x12, 0x4c, 0x61, 0x73, 0x74, 0x56, 0x61,
...
var file_cosmos_staking_v1beta1_genesis_proto_goTypes = []interface{}{
	...
	(*PeriodDelegation)(nil),    // 7: cosmos.staking.v1beta1.PeriodDelegation
}
var file_cosmos_staking_v1beta1_genesis_proto_depIdxs = []int32{
	...
	7, // 6: cosmos.staking.v1beta1.GenesisState.period_delegations:type_name -> cosmos.staking.v1beta1.PeriodDelegation
