...
var (
	md_PeriodDelegationResponse                   protoreflect.MessageDescriptor
	fd_PeriodDelegationResponse_period_delegation protoreflect.FieldDescriptor
	fd_PeriodDelegationResponse_balance           protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_staking_proto_init()
	md_PeriodDelegationResponse = File_cosmos_staking_v1beta1_staking_proto.Messages().ByName("PeriodDelegationResponse")
	fd_PeriodDelegationResponse_period_delegation = md_PeriodDelegationResponse.Fields().ByName("period_delegation")
	fd_PeriodDelegationResponse_balance = md_PeriodDelegationResponse.Fields().ByName("balance")
}

var _ protoreflect.Message = (*fastReflection_PeriodDelegationResponse)(nil)

type fastReflection_PeriodDelegationResponse PeriodDelegationResponse

func (x *PeriodDelegationResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_PeriodDelegationResponse)(x)
}

func (x *PeriodDelegationResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_PeriodDelegationResponse_messageType fastReflection_PeriodDelegationResponse_messageType
var _ protoreflect.MessageType = fastReflection_PeriodDelegationResponse_messageType{}

type fastReflection_PeriodDelegationResponse_messageType struct{}

func (x fastReflection_PeriodDelegationResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_PeriodDelegationResponse)(nil)
}
func (x fastReflection_PeriodDelegationResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_PeriodDelegationResponse)
}
func (x fastReflection_PeriodDelegationResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_PeriodDelegationResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_PeriodDelegationResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_PeriodDelegationResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_PeriodDelegationResponse) Type() protoreflect.MessageType {
	return _fastReflection_PeriodDelegationResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_PeriodDelegationResponse) New() protoreflect.Message {
	return new(fastReflection_PeriodDelegationResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_PeriodDelegationResponse) Interface() protoreflect.ProtoMessage {
	return (*PeriodDelegationResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_PeriodDelegationResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.PeriodDelegation != nil {
		value := protoreflect.ValueOfMessage(x.PeriodDelegation.ProtoReflect())
		if !f(fd_PeriodDelegationResponse_period_delegation, value) {
			return
		}
	}
	if x.Balance != nil {
		value := protoreflect.ValueOfMessage(x.Balance.ProtoReflect())
		if !f(fd_PeriodDelegationResponse_balance, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_PeriodDelegationResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		return x.PeriodDelegation != nil
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		return x.Balance != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.PeriodDelegationResponse"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.PeriodDelegationResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PeriodDelegationResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		x.PeriodDelegation = nil
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		x.Balance = nil
	default:
		if fd.IsExtension() {
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_PeriodDelegationResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		value := x.PeriodDelegation
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		value := x.Balance
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.PeriodDelegationResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PeriodDelegationResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		x.PeriodDelegation = value.Message().Interface().(*PeriodDelegation)
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		x.Balance = value.Message().Interface().(*v1beta1.Coin)
	default:
		if fd.IsExtension() {
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PeriodDelegationResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		if x.PeriodDelegation == nil {
			x.PeriodDelegation = new(PeriodDelegation)
		}
		return protoreflect.ValueOfMessage(x.PeriodDelegation.ProtoReflect())
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		if x.Balance == nil {
			x.Balance = new(v1beta1.Coin)
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_PeriodDelegationResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation":
		m := new(PeriodDelegation)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	case "cosmos.staking.v1beta1.PeriodDelegationResponse.balance":
		m := new(v1beta1.Coin)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_PeriodDelegationResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.PeriodDelegationResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_PeriodDelegationResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_PeriodDelegationResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_PeriodDelegationResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_PeriodDelegationResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*PeriodDelegationResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if x.PeriodDelegation != nil {
			l = options.Size(x.PeriodDelegation)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.Balance != nil {
			l = options.Size(x.Balance)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PeriodDelegation != nil {
			encoded, err := options.Marshal(x.PeriodDelegation)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: PeriodDelegationResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: PeriodDelegationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PeriodDelegation", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.PeriodDelegation == nil {
					x.PeriodDelegation = &PeriodDelegation{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PeriodDelegation); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 2:
...
type PeriodDelegationResponse struct {
	...
	PeriodDelegation *PeriodDelegation `protobuf:"bytes,1,opt,name=period_delegation,json=periodDelegation,proto3" json:"period_delegation,omitempty"`
	Balance          *v1beta1.Coin     `protobuf:"bytes,2,opt,name=balance,proto3" json:"balance,omitempty"`
}

func (x *PeriodDelegationResponse) Reset() {
	*x = PeriodDelegationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_staking_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *PeriodDelegationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeriodDelegationResponse) ProtoMessage() {}

// Deprecated: Use PeriodDelegationResponse.ProtoReflect.Descriptor instead.
func (*PeriodDelegationResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_staking_proto_rawDescGZIP(), []int{20}
}

func (x *PeriodDelegationResponse) GetPeriodDelegation() *PeriodDelegation {
	if x != nil {
		return x.PeriodDelegation
	}
	return nil
}

func (x *PeriodDelegationResponse) GetBalance() *v1beta1.Coin {
	if x != nil {
		return x.Balance
	}
	return nil
...
var file_cosmos_staking_v1beta1_staking_proto_rawDesc = []byte{
	...
	0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x8d, 0x09, 0x0a, 0x09, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x69, 0x6e, 0x67, 0x49, 0x64, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72,
	0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0e, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x10, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x58, 0x0a, 0x0e, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x08, 0x74, 0x72, 0x69, 0x70, 0x6c, 0x65, 0x74, 0x73, 0x22, 0xdc, 0x01,
	0x0a, 0x06, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x65, 0x72, 0x69,
	0x6f, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x70,
	...
	0x69, 0x70, 0x6c, 0x69, 0x65, 0x72, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xee, 0x03, 0x0a,
	...
	0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x37, 0x0a, 0x14, 0x70, 0x65, 0x72, 0x69,
	0x6f, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x12, 0x70,
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49,
	0x64, 0x12, 0x49, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	...
	0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x1b, 0x63, 0x6f,
	0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e,
	0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x44, 0x65, 0x63, 0xd2, 0xb4, 0x2d, 0x0a, 0x63, 0x6f, 0x73,
	0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x0d, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73,
	0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x70, 0x65, 0x72,
	...
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xd2, 0x02,
	...
	0x64, 0x73, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0,
	...
	0x1f, 0x00, 0x22, 0xd4, 0x03, 0x0a, 0x18, 0x55, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	...
	0x6c, 0x64, 0x52, 0x65, 0x66, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x37, 0x0a, 0x14, 0x70, 0x65,
	0x72, 0x69, 0x6f, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52,
	0x12, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x49, 0x64, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xd8, 0x03, 0x0a, 0x11, 0x52, 0x65,
	...
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x37, 0x0a, 0x14, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f,
	0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x12, 0x70, 0x65, 0x72, 0x69,
	0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x3a, 0x04,
	...
	0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x95, 0x06, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12,
	...
	,
	...
	,
	...
	0x63, 0x65, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xc2, 0x01, 0x0a, 0x18, 0x50, 0x65, 0x72,
	0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x60, 0x0a, 0x11, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f,
	0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x28, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e,
	...
	0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x10, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c,
...
var file_cosmos_staking_v1beta1_staking_proto_goTypes = []interface{}{
	...
	(*PeriodDelegationResponse)(nil),  // 22: cosmos.staking.v1beta1.PeriodDelegationResponse
...
var file_cosmos_staking_v1beta1_staking_proto_depIdxs = []int32{
	...
	30, // 11: cosmos.staking.v1beta1.Period.duration:type_name -> google.protobuf.Duration
	28, // 12: cosmos.staking.v1beta1.PeriodDelegation.end_time:type_name -> google.protobuf.Timestamp
	17, // 13: cosmos.staking.v1beta1.UnbondingDelegation.entries:type_name -> cosmos.staking.v1beta1.UnbondingDelegationEntry
	28, // 14: cosmos.staking.v1beta1.UnbondingDelegationEntry.completion_time:type_name -> google.protobuf.Timestamp
	28, // 15: cosmos.staking.v1beta1.RedelegationEntry.completion_time:type_name -> google.protobuf.Timestamp
	18, // 16: cosmos.staking.v1beta1.Redelegation.entries:type_name -> cosmos.staking.v1beta1.RedelegationEntry
	30, // 17: cosmos.staking.v1beta1.Params.unbonding_time:type_name -> google.protobuf.Duration
	...
	31, // 21: cosmos.staking.v1beta1.DelegationResponse.balance:type_name -> cosmos.base.v1beta1.Coin
	14, // 22: cosmos.staking.v1beta1.PeriodDelegationResponse.period_delegation:type_name -> cosmos.staking.v1beta1.PeriodDelegation
	31, // 23: cosmos.staking.v1beta1.PeriodDelegationResponse.balance:type_name -> cosmos.base.v1beta1.Coin
	18, // 24: cosmos.staking.v1beta1.RedelegationEntryResponse.redelegation_entry:type_name -> cosmos.staking.v1beta1.RedelegationEntry
	19, // 25: cosmos.staking.v1beta1.RedelegationResponse.redelegation:type_name -> cosmos.staking.v1beta1.Redelegation
	23, // 26: cosmos.staking.v1beta1.RedelegationResponse.entries:type_name -> cosmos.staking.v1beta1.RedelegationEntryResponse
	32, // 27: cosmos.staking.v1beta1.ValidatorUpdates.updates:type_name -> tendermint.abci.ValidatorUpdate
...
func file_cosmos_staking_v1beta1_staking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_staking_v1beta1_staking_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PeriodDelegationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
