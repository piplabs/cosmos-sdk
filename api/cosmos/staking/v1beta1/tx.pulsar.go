...
var (
	...
	fd_MsgBeginRedelegate_apply_rewards_shares_fix protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgBeginRedelegate_apply_rewards_shares_fix = md_MsgBeginRedelegate.Fields().ByName("apply_rewards_shares_fix")
}
...
func (x *fastReflection_MsgBeginRedelegate) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ApplyRewardsSharesFix != false {
		value := protoreflect.ValueOfBool(x.ApplyRewardsSharesFix)
		if !f(fd_MsgBeginRedelegate_apply_rewards_shares_fix, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgBeginRedelegate) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.MsgBeginRedelegate.period_delegation_id":
		return x.PeriodDelegationId != ""
	case "cosmos.staking.v1beta1.MsgBeginRedelegate.apply_rewards_shares_fix":
		return x.ApplyRewardsSharesFix != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgBeginRedelegate) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.staking.v1beta1.MsgBeginRedelegate.period_delegation_id":
		x.PeriodDelegationId = value.Interface().(string)
	case "cosmos.staking.v1beta1.MsgBeginRedelegate.apply_rewards_shares_fix":
		x.ApplyRewardsSharesFix = value.Bool()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.MsgBeginRedelegate"))
		}
...
func (x *fastReflection_MsgBeginRedelegate) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.MsgBeginRedelegate.apply_rewards_shares_fix":
		panic(fmt.Errorf("field apply_rewards_shares_fix of message cosmos.staking.v1beta1.MsgBeginRedelegate is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.MsgBeginRedelegate"))
		}
...
func (x *fastReflection_MsgBeginRedelegate) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ApplyRewardsSharesFix", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ApplyRewardsSharesFix = bool(v != 0)
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
				if err != nil {
...
var (
	...
	fd_MsgBeginRedelegateResponse_amount          protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgBeginRedelegateResponse_amount = md_MsgBeginRedelegateResponse.Fields().ByName("amount")
}
...
func (x *fastReflection_MsgBeginRedelegateResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Amount != nil {
		value := protoreflect.ValueOfMessage(x.Amount.ProtoReflect())
		if !f(fd_MsgBeginRedelegateResponse_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgBeginRedelegateResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.MsgBeginRedelegateResponse.amount":
		return x.Amount != nil
	default:
		if fd.IsExtension() {
...
var (
	...
	fd_MsgUndelegate_apply_rewards_shares_fix protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgUndelegate_apply_rewards_shares_fix = md_MsgUndelegate.Fields().ByName("apply_rewards_shares_fix")
}
...
func (x *fastReflection_MsgUndelegate) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ApplyRewardsSharesFix != false {
		value := protoreflect.ValueOfBool(x.ApplyRewardsSharesFix)
		if !f(fd_MsgUndelegate_apply_rewards_shares_fix, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgUndelegate) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.staking.v1beta1.MsgUndelegate.period_delegation_id":
		return x.PeriodDelegationId != ""
	case "cosmos.staking.v1beta1.MsgUndelegate.apply_rewards_shares_fix":
		return x.ApplyRewardsSharesFix != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgUndelegate) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v1beta1.MsgUndelegate.apply_rewards_shares_fix":
		panic(fmt.Errorf("field apply_rewards_shares_fix of message cosmos.staking.v1beta1.MsgUndelegate is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.MsgUndelegate"))
		}
...
func (x *MsgCreateValidator) GetSupportTokenType() int32 {
	if x != nil {
...
func (x *MsgDelegate) GetPeriodType() int32 {
	if x != nil {
		return x.PeriodType
	}
	return 0
...
func (x *MsgBeginRedelegate) GetApplyRewardsSharesFix() bool {
	if x != nil {
		return x.ApplyRewardsSharesFix
	}
	return false
}
...
func (x *MsgBeginRedelegateResponse) GetAmount() *v1beta1.Coin {
	if x != nil {
		return x.Amount
	}
	return nil
...
func (x *MsgUndelegate) GetApplyRewardsSharesFix() bool {
	if x != nil {
		return x.ApplyRewardsSharesFix
	}
	return false
...
var file_cosmos_staking_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x05, 0x0a, 0x12, 0x4d, 0x73, 0x67,
	...
	0x61, 0x6c, 0x75, 0x65, 0x12, 0x33, 0x0a, 0x12, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x5f,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05,
	0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x10, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x3a, 0x40, 0x88, 0xa0, 0x1f, 0x00, 0xe8,
	...
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xfe, 0x02,
	...
	0x6e, 0x74, 0x12, 0x37, 0x0a, 0x14, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x64, 0x65, 0x6c,
	0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x12, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44,
	0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0b, 0x70,
	0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05,
	0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0a, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x54,
	0x79, 0x70, 0x65, 0x3a, 0x39, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x82, 0xe7, 0xb0,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xfb, 0x03, 0x0a, 0x12, 0x4d, 0x73, 0x67, 0x42, 0x65, 0x67,
	...
	,
	...
	0x61, 0x74, 0x65, 0x22, 0xae, 0x01, 0x0a, 0x1a, 0x4d, 0x73, 0x67, 0x42, 0x65, 0x67, 0x69, 0x6e,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x93, 0x03, 0x0a, 0x0d, 0x4d, 0x73, 0x67, 0x55, 0x6e, 0x64, 0x65,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x37, 0x0a, 0x14, 0x70,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x18, 0x61, 0x70, 0x70, 0x6c, 0x79, 0x5f, 0x72, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x73, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x5f, 0x66, 0x69, 0x78,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x61, 0x70, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x77,
	0x61, 0x72, 0x64, 0x73, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x46, 0x69, 0x78, 0x3a, 0x3b, 0x88,
	...
	0x72, 0x61, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8b, 0x05, 0x0a,
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a, 0x0c, 0x55, 0x70, 0x64,
...
var file_cosmos_staking_v1beta1_tx_proto_depIdxs = []int32{
	...
	17, // 8: cosmos.staking.v1beta1.MsgBeginRedelegateResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	...
	17, // 11: cosmos.staking.v1beta1.MsgUndelegateResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	17, // 12: cosmos.staking.v1beta1.MsgCancelUnbondingDelegation.amount:type_name -> cosmos.base.v1beta1.Coin
	19, // 13: cosmos.staking.v1beta1.MsgUpdateParams.params:type_name -> cosmos.staking.v1beta1.Params
