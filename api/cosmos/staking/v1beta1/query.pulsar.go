...
var (
	md_QueryDelegationsRequest            protoreflect.MessageDescriptor
	fd_QueryDelegationsRequest_pagination protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryDelegationsRequest = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryDelegationsRequest")
	fd_QueryDelegationsRequest_pagination = md_QueryDelegationsRequest.Fields().ByName("pagination")
}

var _ protoreflect.Message = (*fastReflection_QueryDelegationsRequest)(nil)

type fastReflection_QueryDelegationsRequest QueryDelegationsRequest

func (x *QueryDelegationsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryDelegationsRequest)(x)
}

func (x *QueryDelegationsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryDelegationsRequest_messageType fastReflection_QueryDelegationsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryDelegationsRequest_messageType{}

type fastReflection_QueryDelegationsRequest_messageType struct{}

func (x fastReflection_QueryDelegationsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryDelegationsRequest)(nil)
}
func (x fastReflection_QueryDelegationsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryDelegationsRequest)
}
func (x fastReflection_QueryDelegationsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDelegationsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryDelegationsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDelegationsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryDelegationsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryDelegationsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryDelegationsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryDelegationsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryDelegationsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryDelegationsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryDelegationsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Pagination != nil {
		value := protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
		if !f(fd_QueryDelegationsRequest_pagination, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryDelegationsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryDelegationsRequest"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryDelegationsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		x.Pagination = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryDelegationsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		value := x.Pagination
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryDelegationsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		x.Pagination = value.Message().Interface().(*v1beta1.PageRequest)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		if x.Pagination == nil {
			x.Pagination = new(v1beta1.PageRequest)
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryDelegationsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsRequest.pagination":
		m := new(v1beta1.PageRequest)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryDelegationsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryDelegationsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryDelegationsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryDelegationsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryDelegationsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryDelegationsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDelegationsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDelegationsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_QueryDelegationsResponse_1_list)(nil)

type _QueryDelegationsResponse_1_list struct {
	list *[]*Delegation
}

func (x *_QueryDelegationsResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryDelegationsResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryDelegationsResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Delegation)
	(*x.list)[i] = concreteValue
}

func (x *_QueryDelegationsResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Delegation)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryDelegationsResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(Delegation)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryDelegationsResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryDelegationsResponse_1_list) NewElement() protoreflect.Value {
	v := new(Delegation)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryDelegationsResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryDelegationsResponse             protoreflect.MessageDescriptor
	fd_QueryDelegationsResponse_delegations protoreflect.FieldDescriptor
	fd_QueryDelegationsResponse_pagination  protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryDelegationsResponse = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryDelegationsResponse")
	fd_QueryDelegationsResponse_delegations = md_QueryDelegationsResponse.Fields().ByName("delegations")
	fd_QueryDelegationsResponse_pagination = md_QueryDelegationsResponse.Fields().ByName("pagination")
}

var _ protoreflect.Message = (*fastReflection_QueryDelegationsResponse)(nil)

type fastReflection_QueryDelegationsResponse QueryDelegationsResponse

func (x *QueryDelegationsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryDelegationsResponse)(x)
}

func (x *QueryDelegationsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryDelegationsResponse_messageType fastReflection_QueryDelegationsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryDelegationsResponse_messageType{}

type fastReflection_QueryDelegationsResponse_messageType struct{}

func (x fastReflection_QueryDelegationsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryDelegationsResponse)(nil)
}
func (x fastReflection_QueryDelegationsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryDelegationsResponse)
}
func (x fastReflection_QueryDelegationsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDelegationsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryDelegationsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryDelegationsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryDelegationsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryDelegationsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryDelegationsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryDelegationsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryDelegationsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryDelegationsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryDelegationsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Delegations) != 0 {
		value := protoreflect.ValueOfList(&_QueryDelegationsResponse_1_list{list: &x.Delegations})
		if !f(fd_QueryDelegationsResponse_delegations, value) {
			return
		}
	}
	if x.Pagination != nil {
		value := protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
		if !f(fd_QueryDelegationsResponse_pagination, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryDelegationsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		return len(x.Delegations) != 0
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryDelegationsResponse"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryDelegationsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		x.Delegations = nil
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.pagination":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryDelegationsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		if len(x.Delegations) == 0 {
			return protoreflect.ValueOfList(&_QueryDelegationsResponse_1_list{})
		}
		listValue := &_QueryDelegationsResponse_1_list{list: &x.Delegations}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.pagination":
		value := x.Pagination
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryDelegationsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		lv := value.List()
		clv := lv.(*_QueryDelegationsResponse_1_list)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		if x.Delegations == nil {
			x.Delegations = []*Delegation{}
		}
		value := &_QueryDelegationsResponse_1_list{list: &x.Delegations}
		return protoreflect.ValueOfList(value)
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.pagination":
		if x.Pagination == nil {
			x.Pagination = new(v1beta1.PageResponse)
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryDelegationsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.delegations":
		list := []*Delegation{}
		return protoreflect.ValueOfList(&_QueryDelegationsResponse_1_list{list: &list})
	case "cosmos.staking.v1beta1.QueryDelegationsResponse.pagination":
		m := new(v1beta1.PageResponse)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryDelegationsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryDelegationsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryDelegationsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryDelegationsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryDelegationsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryDelegationsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryDelegationsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDelegationsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryDelegationsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_QueryPeriodDelegationsRequest                protoreflect.MessageDescriptor
	fd_QueryPeriodDelegationsRequest_delegator_addr protoreflect.FieldDescriptor
	fd_QueryPeriodDelegationsRequest_validator_addr protoreflect.FieldDescriptor
	fd_QueryPeriodDelegationsRequest_pagination     protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryPeriodDelegationsRequest = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryPeriodDelegationsRequest")
	fd_QueryPeriodDelegationsRequest_delegator_addr = md_QueryPeriodDelegationsRequest.Fields().ByName("delegator_addr")
	fd_QueryPeriodDelegationsRequest_validator_addr = md_QueryPeriodDelegationsRequest.Fields().ByName("validator_addr")
	fd_QueryPeriodDelegationsRequest_pagination = md_QueryPeriodDelegationsRequest.Fields().ByName("pagination")
}

var _ protoreflect.Message = (*fastReflection_QueryPeriodDelegationsRequest)(nil)

type fastReflection_QueryPeriodDelegationsRequest QueryPeriodDelegationsRequest

func (x *QueryPeriodDelegationsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationsRequest)(x)
}

func (x *QueryPeriodDelegationsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryPeriodDelegationsRequest_messageType fastReflection_QueryPeriodDelegationsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryPeriodDelegationsRequest_messageType{}

type fastReflection_QueryPeriodDelegationsRequest_messageType struct{}

func (x fastReflection_QueryPeriodDelegationsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationsRequest)(nil)
}
func (x fastReflection_QueryPeriodDelegationsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationsRequest)
}
func (x fastReflection_QueryPeriodDelegationsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryPeriodDelegationsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryPeriodDelegationsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryPeriodDelegationsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryPeriodDelegationsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryPeriodDelegationsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryPeriodDelegationsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryPeriodDelegationsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DelegatorAddr != "" {
		value := protoreflect.ValueOfString(x.DelegatorAddr)
		if !f(fd_QueryPeriodDelegationsRequest_delegator_addr, value) {
			return
		}
	}
	if x.ValidatorAddr != "" {
		value := protoreflect.ValueOfString(x.ValidatorAddr)
		if !f(fd_QueryPeriodDelegationsRequest_validator_addr, value) {
			return
		}
	}
	if x.Pagination != nil {
		value := protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
		if !f(fd_QueryPeriodDelegationsRequest_pagination, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryPeriodDelegationsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		return x.DelegatorAddr != ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.validator_addr":
		return x.ValidatorAddr != ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationsRequest"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		x.DelegatorAddr = ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.validator_addr":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryPeriodDelegationsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		value := x.DelegatorAddr
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		x.DelegatorAddr = value.Interface().(string)
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.validator_addr":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.pagination":
		if x.Pagination == nil {
			x.Pagination = new(v1beta1.PageRequest)
		...
		return protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		panic(fmt.Errorf("field delegator_addr of message cosmos.staking.v1beta1.QueryPeriodDelegationsRequest is not mutable"))
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.validator_addr":
		panic(fmt.Errorf("field validator_addr of message cosmos.staking.v1beta1.QueryPeriodDelegationsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationsRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryPeriodDelegationsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.delegator_addr":
		return protoreflect.ValueOfString("")
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.validator_addr":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryPeriodDelegationsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryPeriodDelegationsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryPeriodDelegationsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryPeriodDelegationsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryPeriodDelegationsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryPeriodDelegationsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var _ protoreflect.List = (*_QueryPeriodDelegationsResponse_1_list)(nil)

type _QueryPeriodDelegationsResponse_1_list struct {
	list *[]*PeriodDelegationResponse
}

func (x *_QueryPeriodDelegationsResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryPeriodDelegationsResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryPeriodDelegationsResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*PeriodDelegationResponse)
	(*x.list)[i] = concreteValue
}

func (x *_QueryPeriodDelegationsResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*PeriodDelegationResponse)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryPeriodDelegationsResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(PeriodDelegationResponse)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryPeriodDelegationsResponse_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QueryPeriodDelegationsResponse_1_list) NewElement() protoreflect.Value {
	v := new(PeriodDelegationResponse)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryPeriodDelegationsResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryPeriodDelegationsResponse                             protoreflect.MessageDescriptor
	fd_QueryPeriodDelegationsResponse_period_delegation_responses protoreflect.FieldDescriptor
	fd_QueryPeriodDelegationsResponse_pagination                  protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryPeriodDelegationsResponse = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryPeriodDelegationsResponse")
	fd_QueryPeriodDelegationsResponse_period_delegation_responses = md_QueryPeriodDelegationsResponse.Fields().ByName("period_delegation_responses")
	fd_QueryPeriodDelegationsResponse_pagination = md_QueryPeriodDelegationsResponse.Fields().ByName("pagination")
}

var _ protoreflect.Message = (*fastReflection_QueryPeriodDelegationsResponse)(nil)

type fastReflection_QueryPeriodDelegationsResponse QueryPeriodDelegationsResponse

func (x *QueryPeriodDelegationsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationsResponse)(x)
}

func (x *QueryPeriodDelegationsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryPeriodDelegationsResponse_messageType fastReflection_QueryPeriodDelegationsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryPeriodDelegationsResponse_messageType{}

type fastReflection_QueryPeriodDelegationsResponse_messageType struct{}

func (x fastReflection_QueryPeriodDelegationsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationsResponse)(nil)
}
func (x fastReflection_QueryPeriodDelegationsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationsResponse)
}
func (x fastReflection_QueryPeriodDelegationsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryPeriodDelegationsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryPeriodDelegationsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryPeriodDelegationsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryPeriodDelegationsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryPeriodDelegationsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryPeriodDelegationsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryPeriodDelegationsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.PeriodDelegationResponses) != 0 {
		value := protoreflect.ValueOfList(&_QueryPeriodDelegationsResponse_1_list{list: &x.PeriodDelegationResponses})
		if !f(fd_QueryPeriodDelegationsResponse_period_delegation_responses, value) {
			return
		}
	}
	if x.Pagination != nil {
		value := protoreflect.ValueOfMessage(x.Pagination.ProtoReflect())
		if !f(fd_QueryPeriodDelegationsResponse_pagination, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryPeriodDelegationsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		return len(x.PeriodDelegationResponses) != 0
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		return x.Pagination != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationsResponse"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		x.PeriodDelegationResponses = nil
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		x.Pagination = nil
	default:
		if fd.IsExtension() {
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryPeriodDelegationsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		if len(x.PeriodDelegationResponses) == 0 {
			return protoreflect.ValueOfList(&_QueryPeriodDelegationsResponse_1_list{})
		}
		listValue := &_QueryPeriodDelegationsResponse_1_list{list: &x.PeriodDelegationResponses}
		return protoreflect.ValueOfList(listValue)
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		value := x.Pagination
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		lv := value.List()
		clv := lv.(*_QueryPeriodDelegationsResponse_1_list)
		x.PeriodDelegationResponses = *clv.list
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		x.Pagination = value.Message().Interface().(*v1beta1.PageResponse)
	default:
		if fd.IsExtension() {
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		if x.PeriodDelegationResponses == nil {
			x.PeriodDelegationResponses = []*PeriodDelegationResponse{}
		}
		value := &_QueryPeriodDelegationsResponse_1_list{list: &x.PeriodDelegationResponses}
		return protoreflect.ValueOfList(value)
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		if x.Pagination == nil {
			x.Pagination = new(v1beta1.PageResponse)
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryPeriodDelegationsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses":
		list := []*PeriodDelegationResponse{}
		return protoreflect.ValueOfList(&_QueryPeriodDelegationsResponse_1_list{list: &list})
	case "cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination":
		m := new(v1beta1.PageResponse)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryPeriodDelegationsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryPeriodDelegationsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryPeriodDelegationsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryPeriodDelegationsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryPeriodDelegationsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryPeriodDelegationsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if len(x.PeriodDelegationResponses) > 0 {
			for _, e := range x.PeriodDelegationResponses {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PeriodDelegationResponses) > 0 {
			for iNdEx := len(x.PeriodDelegationResponses) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PeriodDelegationResponses[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PeriodDelegationResponses", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PeriodDelegationResponses = append(x.PeriodDelegationResponses, &PeriodDelegationResponse{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PeriodDelegationResponses[len(x.PeriodDelegationResponses)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 2:
...
var (
	md_QueryPeriodDelegationRequest                      protoreflect.MessageDescriptor
	fd_QueryPeriodDelegationRequest_delegator_addr       protoreflect.FieldDescriptor
	fd_QueryPeriodDelegationRequest_validator_addr       protoreflect.FieldDescriptor
	fd_QueryPeriodDelegationRequest_period_delegation_id protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryPeriodDelegationRequest = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryPeriodDelegationRequest")
	fd_QueryPeriodDelegationRequest_delegator_addr = md_QueryPeriodDelegationRequest.Fields().ByName("delegator_addr")
	fd_QueryPeriodDelegationRequest_validator_addr = md_QueryPeriodDelegationRequest.Fields().ByName("validator_addr")
	fd_QueryPeriodDelegationRequest_period_delegation_id = md_QueryPeriodDelegationRequest.Fields().ByName("period_delegation_id")
}

var _ protoreflect.Message = (*fastReflection_QueryPeriodDelegationRequest)(nil)

type fastReflection_QueryPeriodDelegationRequest QueryPeriodDelegationRequest

func (x *QueryPeriodDelegationRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationRequest)(x)
}

func (x *QueryPeriodDelegationRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryPeriodDelegationRequest_messageType fastReflection_QueryPeriodDelegationRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryPeriodDelegationRequest_messageType{}

type fastReflection_QueryPeriodDelegationRequest_messageType struct{}

func (x fastReflection_QueryPeriodDelegationRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationRequest)(nil)
}
func (x fastReflection_QueryPeriodDelegationRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationRequest)
}
func (x fastReflection_QueryPeriodDelegationRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryPeriodDelegationRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryPeriodDelegationRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryPeriodDelegationRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryPeriodDelegationRequest) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryPeriodDelegationRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryPeriodDelegationRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryPeriodDelegationRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DelegatorAddr != "" {
		value := protoreflect.ValueOfString(x.DelegatorAddr)
		if !f(fd_QueryPeriodDelegationRequest_delegator_addr, value) {
			return
		}
	}
	if x.ValidatorAddr != "" {
		value := protoreflect.ValueOfString(x.ValidatorAddr)
		if !f(fd_QueryPeriodDelegationRequest_validator_addr, value) {
			return
		}
	}
	if x.PeriodDelegationId != "" {
		value := protoreflect.ValueOfString(x.PeriodDelegationId)
		if !f(fd_QueryPeriodDelegationRequest_period_delegation_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryPeriodDelegationRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		return x.DelegatorAddr != ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.validator_addr":
		return x.ValidatorAddr != ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.period_delegation_id":
		return x.PeriodDelegationId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationRequest"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		x.DelegatorAddr = ""
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.validator_addr":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryPeriodDelegationRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		value := x.DelegatorAddr
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		x.DelegatorAddr = value.Interface().(string)
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.validator_addr":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		panic(fmt.Errorf("field delegator_addr of message cosmos.staking.v1beta1.QueryPeriodDelegationRequest is not mutable"))
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.validator_addr":
		panic(fmt.Errorf("field validator_addr of message cosmos.staking.v1beta1.QueryPeriodDelegationRequest is not mutable"))
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.period_delegation_id":
		panic(fmt.Errorf("field period_delegation_id of message cosmos.staking.v1beta1.QueryPeriodDelegationRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryPeriodDelegationRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.delegator_addr":
		return protoreflect.ValueOfString("")
	case "cosmos.staking.v1beta1.QueryPeriodDelegationRequest.validator_addr":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryPeriodDelegationRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryPeriodDelegationRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryPeriodDelegationRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryPeriodDelegationRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryPeriodDelegationRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryPeriodDelegationRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_QueryPeriodDelegationResponse                            protoreflect.MessageDescriptor
	fd_QueryPeriodDelegationResponse_period_delegation_response protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v1beta1_query_proto_init()
	md_QueryPeriodDelegationResponse = File_cosmos_staking_v1beta1_query_proto.Messages().ByName("QueryPeriodDelegationResponse")
	fd_QueryPeriodDelegationResponse_period_delegation_response = md_QueryPeriodDelegationResponse.Fields().ByName("period_delegation_response")
}

var _ protoreflect.Message = (*fastReflection_QueryPeriodDelegationResponse)(nil)

type fastReflection_QueryPeriodDelegationResponse QueryPeriodDelegationResponse

func (x *QueryPeriodDelegationResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationResponse)(x)
}

func (x *QueryPeriodDelegationResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryPeriodDelegationResponse_messageType fastReflection_QueryPeriodDelegationResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryPeriodDelegationResponse_messageType{}

type fastReflection_QueryPeriodDelegationResponse_messageType struct{}

func (x fastReflection_QueryPeriodDelegationResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryPeriodDelegationResponse)(nil)
}
func (x fastReflection_QueryPeriodDelegationResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationResponse)
}
func (x fastReflection_QueryPeriodDelegationResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryPeriodDelegationResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryPeriodDelegationResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryPeriodDelegationResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryPeriodDelegationResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryPeriodDelegationResponse) New() protoreflect.Message {
	return new(fastReflection_QueryPeriodDelegationResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryPeriodDelegationResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryPeriodDelegationResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryPeriodDelegationResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.PeriodDelegationResponse != nil {
		value := protoreflect.ValueOfMessage(x.PeriodDelegationResponse.ProtoReflect())
		if !f(fd_QueryPeriodDelegationResponse_period_delegation_response, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryPeriodDelegationResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		return x.PeriodDelegationResponse != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		x.PeriodDelegationResponse = nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
		}
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryPeriodDelegationResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		value := x.PeriodDelegationResponse
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
		}
		panic(fmt.Errorf("message cosmos.staking.v1beta1.QueryPeriodDelegationResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		x.PeriodDelegationResponse = value.Message().Interface().(*PeriodDelegationResponse)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		if x.PeriodDelegationResponse == nil {
			x.PeriodDelegationResponse = new(PeriodDelegationResponse)
		}
		return protoreflect.ValueOfMessage(x.PeriodDelegationResponse.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryPeriodDelegationResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response":
		m := new(PeriodDelegationResponse)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v1beta1.QueryPeriodDelegationResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryPeriodDelegationResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v1beta1.QueryPeriodDelegationResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryPeriodDelegationResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryPeriodDelegationResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryPeriodDelegationResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryPeriodDelegationResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryPeriodDelegationResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		_ = l
		if x.PeriodDelegationResponse != nil {
			l = options.Size(x.PeriodDelegationResponse)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PeriodDelegationResponse != nil {
			encoded, err := options.Marshal(x.PeriodDelegationResponse)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryPeriodDelegationResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PeriodDelegationResponse", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.PeriodDelegationResponse == nil {
					x.PeriodDelegationResponse = &PeriodDelegationResponse{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PeriodDelegationResponse); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
// QueryDelegationsRequest is request type for Query/Delegations RPC method.
...
func (x *QueryDelegationsRequest) Reset() {
	*x = QueryDelegationsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryDelegationsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryDelegationsRequest) ProtoMessage() {}

// Deprecated: Use QueryDelegationsRequest.ProtoReflect.Descriptor instead.
func (*QueryDelegationsRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{2}
}

func (x *QueryDelegationsRequest) GetPagination() *v1beta1.PageRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
type QueryDelegationsResponse struct {
	...
	// delegations contains all the queried delegations.
	Delegations []*Delegation `protobuf:"bytes,1,rep,name=delegations,proto3" json:"delegations,omitempty"`
	// pagination defines the pagination in the response.
	Pagination *v1beta1.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (x *QueryDelegationsResponse) Reset() {
	*x = QueryDelegationsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryDelegationsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryDelegationsResponse) ProtoMessage() {}

// Deprecated: Use QueryDelegationsResponse.ProtoReflect.Descriptor instead.
func (*QueryDelegationsResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{3}
}

func (x *QueryDelegationsResponse) GetDelegations() []*Delegation {
	if x != nil {
...
func (x *QueryDelegationsResponse) GetPagination() *v1beta1.PageResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
// QueryPeriodDelegationsRequest is request type for the Query/PeriodDelegations RPC method.
type QueryPeriodDelegationsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryPeriodDelegationsRequest) Reset() {
	*x = QueryPeriodDelegationsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryPeriodDelegationsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPeriodDelegationsRequest) ProtoMessage() {}

// Deprecated: Use QueryPeriodDelegationsRequest.ProtoReflect.Descriptor instead.
func (*QueryPeriodDelegationsRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{16}
}

func (x *QueryPeriodDelegationsRequest) GetDelegatorAddr() string {
	if x != nil {
		return x.DelegatorAddr
	}
	return ""
...
func (x *QueryPeriodDelegationsRequest) GetValidatorAddr() string {
	if x != nil {
		return x.ValidatorAddr
	}
	return ""
...
func (x *QueryPeriodDelegationsRequest) GetPagination() *v1beta1.PageRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
// QueryPeriodDelegationsResponse is response type for the Query/PeriodDelegations RPC method.
type QueryPeriodDelegationsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// period_delegation_responses defines the period delegations info.
	PeriodDelegationResponses []*PeriodDelegationResponse `protobuf:"bytes,1,rep,name=period_delegation_responses,json=periodDelegationResponses,proto3" json:"period_delegation_responses,omitempty"`
	// pagination defines the pagination in the response.
	Pagination *v1beta1.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (x *QueryPeriodDelegationsResponse) Reset() {
	*x = QueryPeriodDelegationsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryPeriodDelegationsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPeriodDelegationsResponse) ProtoMessage() {}

// Deprecated: Use QueryPeriodDelegationsResponse.ProtoReflect.Descriptor instead.
func (*QueryPeriodDelegationsResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{17}
}

func (x *QueryPeriodDelegationsResponse) GetPeriodDelegationResponses() []*PeriodDelegationResponse {
	if x != nil {
		return x.PeriodDelegationResponses
	}
	return nil
}

func (x *QueryPeriodDelegationsResponse) GetPagination() *v1beta1.PageResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
// QueryPeriodDelegationRequest is request type for the Query/PeriodDelegation RPC method.
type QueryPeriodDelegationRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// validator_addr defines the validator address to query for.
	ValidatorAddr string `protobuf:"bytes,2,opt,name=validator_addr,json=validatorAddr,proto3" json:"validator_addr,omitempty"`
	// period_delegation_id defines the period delegation id to query for.
...
func (x *QueryPeriodDelegationRequest) Reset() {
	*x = QueryPeriodDelegationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryPeriodDelegationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPeriodDelegationRequest) ProtoMessage() {}

// Deprecated: Use QueryPeriodDelegationRequest.ProtoReflect.Descriptor instead.
func (*QueryPeriodDelegationRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{18}
}

func (x *QueryPeriodDelegationRequest) GetDelegatorAddr() string {
	if x != nil {
		return x.DelegatorAddr
	}
	return ""
...
func (x *QueryPeriodDelegationRequest) GetValidatorAddr() string {
	if x != nil {
		return x.ValidatorAddr
	}
	return ""
...
func (x *QueryPeriodDelegationRequest) GetPeriodDelegationId() string {
	if x != nil {
		return x.PeriodDelegationId
	}
	return ""
...
// QueryPeriodDelegationResponse is response type for the Query/PeriodDelegation RPC method.
type QueryPeriodDelegationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// period_delegation_response defines the period delegation info.
	PeriodDelegationResponse *PeriodDelegationResponse `protobuf:"bytes,1,opt,name=period_delegation_response,json=periodDelegationResponse,proto3" json:"period_delegation_response,omitempty"`
}

func (x *QueryPeriodDelegationResponse) Reset() {
	*x = QueryPeriodDelegationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_staking_v1beta1_query_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryPeriodDelegationResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryPeriodDelegationResponse) ProtoMessage() {}

// Deprecated: Use QueryPeriodDelegationResponse.ProtoReflect.Descriptor instead.
func (*QueryPeriodDelegationResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v1beta1_query_proto_rawDescGZIP(), []int{19}
}

func (x *QueryPeriodDelegationResponse) GetPeriodDelegationResponse() *PeriodDelegationResponse {
	if x != nil {
		return x.PeriodDelegationResponse
	}
	return nil
}
...
var file_cosmos_staking_v1beta1_query_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x79, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65,
	...
	0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4f, 0x0a, 0x0b, 0x64, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x61, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x48, 0x0a,
	...
	0x74, 0x6f, 0x72, 0x41, 0x64, 0x64, 0x72, 0x22, 0x64, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0xed, 0x01, 0x0a, 0x21, 0x51, 0x75, 0x65, 0x72, 0x79, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7f, 0x0a, 0x14, 0x64, 0x65,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xad, 0x01, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44,
	...
	0x0a, 0x1f, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x6e, 0x62, 0x6f, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	...
	0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xfc, 0x01, 0x0a, 0x1d,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67,
	...
	0x3a, 0x08, 0x88, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xe6, 0x01, 0x0a, 0x1e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7b, 0x0a,
	0x1b, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69,
	...
	0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52,
	0x19, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	...
	0x69, 0x6f, 0x6e, 0x22, 0xec, 0x01, 0x0a, 0x1c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x65, 0x72,
	0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	...
	,
	...
	0x22, 0xde, 0x01, 0x0a, 0x2a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61,
	...
	,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x32, 0xd6, 0x1b, 0x0a, 0x05,
	...
	,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x7d, 0x2f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64,
	0x5f, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x88, 0x02, 0x0a,
	0x10, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x44, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f,
	...
	,
...
var file_cosmos_staking_v1beta1_query_proto_goTypes = []interface{}{
	...
	(*QueryDelegationsRequest)(nil),                    // 2: cosmos.staking.v1beta1.QueryDelegationsRequest
	(*QueryDelegationsResponse)(nil),                   // 3: cosmos.staking.v1beta1.QueryDelegationsResponse
	...
	(*QueryPeriodDelegationsRequest)(nil),              // 16: cosmos.staking.v1beta1.QueryPeriodDelegationsRequest
	(*QueryPeriodDelegationsResponse)(nil),             // 17: cosmos.staking.v1beta1.QueryPeriodDelegationsResponse
	(*QueryPeriodDelegationRequest)(nil),               // 18: cosmos.staking.v1beta1.QueryPeriodDelegationRequest
	(*QueryPeriodDelegationResponse)(nil),              // 19: cosmos.staking.v1beta1.QueryPeriodDelegationResponse
	(*QueryDelegatorUnbondingDelegationsRequest)(nil),  // 20: cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsRequest
	(*QueryDelegatorUnbondingDelegationsResponse)(nil), // 21: cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsResponse
	(*QueryRedelegationsRequest)(nil),                  // 22: cosmos.staking.v1beta1.QueryRedelegationsRequest
	(*QueryRedelegationsResponse)(nil),                 // 23: cosmos.staking.v1beta1.QueryRedelegationsResponse
	(*QueryDelegatorValidatorsRequest)(nil),            // 24: cosmos.staking.v1beta1.QueryDelegatorValidatorsRequest
	(*QueryDelegatorValidatorsResponse)(nil),           // 25: cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse
	(*QueryDelegatorValidatorRequest)(nil),             // 26: cosmos.staking.v1beta1.QueryDelegatorValidatorRequest
	(*QueryDelegatorValidatorResponse)(nil),            // 27: cosmos.staking.v1beta1.QueryDelegatorValidatorResponse
	(*QueryHistoricalInfoRequest)(nil),                 // 28: cosmos.staking.v1beta1.QueryHistoricalInfoRequest
	(*QueryHistoricalInfoResponse)(nil),                // 29: cosmos.staking.v1beta1.QueryHistoricalInfoResponse
	(*QueryPoolRequest)(nil),                           // 30: cosmos.staking.v1beta1.QueryPoolRequest
	(*QueryPoolResponse)(nil),                          // 31: cosmos.staking.v1beta1.QueryPoolResponse
	(*QueryParamsRequest)(nil),                         // 32: cosmos.staking.v1beta1.QueryParamsRequest
	(*QueryParamsResponse)(nil),                        // 33: cosmos.staking.v1beta1.QueryParamsResponse
	(*v1beta1.PageRequest)(nil),                        // 34: cosmos.base.query.v1beta1.PageRequest
	(*Validator)(nil),                                  // 35: cosmos.staking.v1beta1.Validator
	(*v1beta1.PageResponse)(nil),                       // 36: cosmos.base.query.v1beta1.PageResponse
	(*Delegation)(nil),                                 // 37: cosmos.staking.v1beta1.Delegation
	...
	(*PeriodDelegationResponse)(nil),                   // 40: cosmos.staking.v1beta1.PeriodDelegationResponse
	(*RedelegationResponse)(nil),                       // 41: cosmos.staking.v1beta1.RedelegationResponse
	(*HistoricalInfo)(nil),                             // 42: cosmos.staking.v1beta1.HistoricalInfo
	(*Pool)(nil),                                       // 43: cosmos.staking.v1beta1.Pool
	(*Params)(nil),                                     // 44: cosmos.staking.v1beta1.Params
}
var file_cosmos_staking_v1beta1_query_proto_depIdxs = []int32{
	34, // 0: cosmos.staking.v1beta1.QueryValidatorsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	35, // 1: cosmos.staking.v1beta1.QueryValidatorsResponse.validators:type_name -> cosmos.staking.v1beta1.Validator
	36, // 2: cosmos.staking.v1beta1.QueryValidatorsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 3: cosmos.staking.v1beta1.QueryDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	37, // 4: cosmos.staking.v1beta1.QueryDelegationsResponse.delegations:type_name -> cosmos.staking.v1beta1.Delegation
	36, // 5: cosmos.staking.v1beta1.QueryDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	35, // 6: cosmos.staking.v1beta1.QueryValidatorResponse.validator:type_name -> cosmos.staking.v1beta1.Validator
	34, // 7: cosmos.staking.v1beta1.QueryValidatorDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	38, // 8: cosmos.staking.v1beta1.QueryValidatorDelegationsResponse.delegation_responses:type_name -> cosmos.staking.v1beta1.DelegationResponse
	36, // 9: cosmos.staking.v1beta1.QueryValidatorDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 10: cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	39, // 11: cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsResponse.unbonding_responses:type_name -> cosmos.staking.v1beta1.UnbondingDelegation
	36, // 12: cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	38, // 13: cosmos.staking.v1beta1.QueryDelegationResponse.delegation_response:type_name -> cosmos.staking.v1beta1.DelegationResponse
	39, // 14: cosmos.staking.v1beta1.QueryUnbondingDelegationResponse.unbond:type_name -> cosmos.staking.v1beta1.UnbondingDelegation
	34, // 15: cosmos.staking.v1beta1.QueryDelegatorDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	38, // 16: cosmos.staking.v1beta1.QueryDelegatorDelegationsResponse.delegation_responses:type_name -> cosmos.staking.v1beta1.DelegationResponse
	36, // 17: cosmos.staking.v1beta1.QueryDelegatorDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 18: cosmos.staking.v1beta1.QueryPeriodDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	40, // 19: cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.period_delegation_responses:type_name -> cosmos.staking.v1beta1.PeriodDelegationResponse
	36, // 20: cosmos.staking.v1beta1.QueryPeriodDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	40, // 21: cosmos.staking.v1beta1.QueryPeriodDelegationResponse.period_delegation_response:type_name -> cosmos.staking.v1beta1.PeriodDelegationResponse
	34, // 22: cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	39, // 23: cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsResponse.unbonding_responses:type_name -> cosmos.staking.v1beta1.UnbondingDelegation
	36, // 24: cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 25: cosmos.staking.v1beta1.QueryRedelegationsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	41, // 26: cosmos.staking.v1beta1.QueryRedelegationsResponse.redelegation_responses:type_name -> cosmos.staking.v1beta1.RedelegationResponse
	36, // 27: cosmos.staking.v1beta1.QueryRedelegationsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	34, // 28: cosmos.staking.v1beta1.QueryDelegatorValidatorsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	35, // 29: cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse.validators:type_name -> cosmos.staking.v1beta1.Validator
	36, // 30: cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	35, // 31: cosmos.staking.v1beta1.QueryDelegatorValidatorResponse.validator:type_name -> cosmos.staking.v1beta1.Validator
	42, // 32: cosmos.staking.v1beta1.QueryHistoricalInfoResponse.hist:type_name -> cosmos.staking.v1beta1.HistoricalInfo
	43, // 33: cosmos.staking.v1beta1.QueryPoolResponse.pool:type_name -> cosmos.staking.v1beta1.Pool
	44, // 34: cosmos.staking.v1beta1.QueryParamsResponse.params:type_name -> cosmos.staking.v1beta1.Params
	0,  // 35: cosmos.staking.v1beta1.Query.Validators:input_type -> cosmos.staking.v1beta1.QueryValidatorsRequest
	4,  // 36: cosmos.staking.v1beta1.Query.Validator:input_type -> cosmos.staking.v1beta1.QueryValidatorRequest
	2,  // 37: cosmos.staking.v1beta1.Query.Delegations:input_type -> cosmos.staking.v1beta1.QueryDelegationsRequest
	6,  // 38: cosmos.staking.v1beta1.Query.ValidatorDelegations:input_type -> cosmos.staking.v1beta1.QueryValidatorDelegationsRequest
	8,  // 39: cosmos.staking.v1beta1.Query.ValidatorUnbondingDelegations:input_type -> cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsRequest
	10, // 40: cosmos.staking.v1beta1.Query.Delegation:input_type -> cosmos.staking.v1beta1.QueryDelegationRequest
	12, // 41: cosmos.staking.v1beta1.Query.UnbondingDelegation:input_type -> cosmos.staking.v1beta1.QueryUnbondingDelegationRequest
	14, // 42: cosmos.staking.v1beta1.Query.DelegatorDelegations:input_type -> cosmos.staking.v1beta1.QueryDelegatorDelegationsRequest
	16, // 43: cosmos.staking.v1beta1.Query.PeriodDelegations:input_type -> cosmos.staking.v1beta1.QueryPeriodDelegationsRequest
	18, // 44: cosmos.staking.v1beta1.Query.PeriodDelegation:input_type -> cosmos.staking.v1beta1.QueryPeriodDelegationRequest
	20, // 45: cosmos.staking.v1beta1.Query.DelegatorUnbondingDelegations:input_type -> cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsRequest
	22, // 46: cosmos.staking.v1beta1.Query.Redelegations:input_type -> cosmos.staking.v1beta1.QueryRedelegationsRequest
	24, // 47: cosmos.staking.v1beta1.Query.DelegatorValidators:input_type -> cosmos.staking.v1beta1.QueryDelegatorValidatorsRequest
	26, // 48: cosmos.staking.v1beta1.Query.DelegatorValidator:input_type -> cosmos.staking.v1beta1.QueryDelegatorValidatorRequest
	28, // 49: cosmos.staking.v1beta1.Query.HistoricalInfo:input_type -> cosmos.staking.v1beta1.QueryHistoricalInfoRequest
	30, // 50: cosmos.staking.v1beta1.Query.Pool:input_type -> cosmos.staking.v1beta1.QueryPoolRequest
	32, // 51: cosmos.staking.v1beta1.Query.Params:input_type -> cosmos.staking.v1beta1.QueryParamsRequest
	1,  // 52: cosmos.staking.v1beta1.Query.Validators:output_type -> cosmos.staking.v1beta1.QueryValidatorsResponse
	5,  // 53: cosmos.staking.v1beta1.Query.Validator:output_type -> cosmos.staking.v1beta1.QueryValidatorResponse
	3,  // 54: cosmos.staking.v1beta1.Query.Delegations:output_type -> cosmos.staking.v1beta1.QueryDelegationsResponse
	7,  // 55: cosmos.staking.v1beta1.Query.ValidatorDelegations:output_type -> cosmos.staking.v1beta1.QueryValidatorDelegationsResponse
	9,  // 56: cosmos.staking.v1beta1.Query.ValidatorUnbondingDelegations:output_type -> cosmos.staking.v1beta1.QueryValidatorUnbondingDelegationsResponse
	11, // 57: cosmos.staking.v1beta1.Query.Delegation:output_type -> cosmos.staking.v1beta1.QueryDelegationResponse
	13, // 58: cosmos.staking.v1beta1.Query.UnbondingDelegation:output_type -> cosmos.staking.v1beta1.QueryUnbondingDelegationResponse
	15, // 59: cosmos.staking.v1beta1.Query.DelegatorDelegations:output_type -> cosmos.staking.v1beta1.QueryDelegatorDelegationsResponse
	17, // 60: cosmos.staking.v1beta1.Query.PeriodDelegations:output_type -> cosmos.staking.v1beta1.QueryPeriodDelegationsResponse
	19, // 61: cosmos.staking.v1beta1.Query.PeriodDelegation:output_type -> cosmos.staking.v1beta1.QueryPeriodDelegationResponse
	21, // 62: cosmos.staking.v1beta1.Query.DelegatorUnbondingDelegations:output_type -> cosmos.staking.v1beta1.QueryDelegatorUnbondingDelegationsResponse
	23, // 63: cosmos.staking.v1beta1.Query.Redelegations:output_type -> cosmos.staking.v1beta1.QueryRedelegationsResponse
	25, // 64: cosmos.staking.v1beta1.Query.DelegatorValidators:output_type -> cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse
	27, // 65: cosmos.staking.v1beta1.Query.DelegatorValidator:output_type -> cosmos.staking.v1beta1.QueryDelegatorValidatorResponse
	29, // 66: cosmos.staking.v1beta1.Query.HistoricalInfo:output_type -> cosmos.staking.v1beta1.QueryHistoricalInfoResponse
	31, // 67: cosmos.staking.v1beta1.Query.Pool:output_type -> cosmos.staking.v1beta1.QueryPoolResponse
	33, // 68: cosmos.staking.v1beta1.Query.Params:output_type -> cosmos.staking.v1beta1.QueryParamsResponse
...
func file_cosmos_staking_v1beta1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryDelegationsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryDelegationsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPeriodDelegationsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPeriodDelegationsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPeriodDelegationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_staking_v1beta1_query_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryPeriodDelegationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
